# -*- coding:utf-8 -*-
"""
 @FileName   : peft_optimizer_constructor.py.py
 @Time       : 8/22/25 4:52 PM
 @Author     : Woldier Wong
 @Description: TODO
"""
import logging
...
class PEFTOptimWrapperConstructor(DefaultOptimWrapperConstructor):
    ...
    def add_params(self, params: List[dict], module: nn.Module, prefix: str = '',
        ...
        for name, param in module.named_parameters(recurse=False):
            if not param.requires_grad: # PEFT
    ...
    def __call__(self, model: nn.Module) -> OptimWrapper:
        ...
        if not self.paramwise_cfg:
            optimizer_cfg[fisrt_arg_name] = [ p for p in model.parameters() if p.requires_grad]  # PEFT
